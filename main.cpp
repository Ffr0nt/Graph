/*
 Template Graph class to represent a directed graph stores information about:
1 The unique keys that can be used to get to the nodes (the name of the nodes);
